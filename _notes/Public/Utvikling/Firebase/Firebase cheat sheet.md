...
Funksjonen vi bruker for å sende data til databasen heter *addDoc*. I addDoc må vi også angi hvilken *collection* dokumentet (dataen) skal lagres i.

Her er et eksempel fra en database med hotellrom, der vi lagrer dokumentene i en collection som heter "hotelrooms":
